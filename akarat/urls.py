...
from .views import fetch_biens_immobiliers,delete_bien,delete_favorie,recherche_biens_immobiliers,favorie_biens,liste_biens,create_favorie,sing_in,create_user,profile_list,fetch_user,biens_immobiliers_list,create_biens_immobiliers
...
urlpatterns = [
    ...
    path('delete_bien/<int:bien_id>/', delete_bien, name='delete_bien'),
